...
def add(request):
    ...
    return redirect('home_route') # TODO: Rediriger vers le panier quand il sera dispo.

def set_quantity(request):
    """
    Répondre à la demande de modification de quantité, puis rediriger l'utilisateur vers le panier.
    """
    product_slug = request.POST.get("slug", "")
...
def delete(request):
    ...
    messages.success(request, f"L'article {product.name} a été supprimer du panier")
