...
CART_SESSION_KEY = 'cart' # Clé du dictionnaire pour stocker le panier de la session
...
class Cart:
    ...
    def add(self, product, quantity = 1):
        """On ajoute un produit au panier s'il n'existe pas, ou on ajuste sa quantité s'il existe déjà"""
    ...
    def remove(self, product):
        """
        On suuprime un produit du panier. On a recours à la fonction pop() des dictionnaires pour extraire.
        """
